...
export default function FormComplaints({ text, onOK }) {
  ...
  const filteredNiss = niss.filter(
          ...
          <View style={styles.container}>
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>
                Si deseas registrar una nueva queja, selecciona la opción de
                "Registrar una nueva queja" y contesta el formulario
              </Text>
              <Image
            ...
            <View style={styles.formAction}>
              <ButtonP onPress={handleNewComplaint}>
          ...
          <View style={styles.container}>
            ...
            <View style={styles.form}>
              <View style={styles.input}>
                ...
                />
                {errors.nis && (
                  <Text style={styles.errorText}>{errors.nis.message}</Text>
                )}
              </View>
              ...
              <View style={styles.input}>
                ...
                <Controller
                  ...
                  rules={{
                    required:
                      "Introduce tu número de teléfono, no puede estar vacío.",
                    pattern: {
                      value: /^\d{10}$/,
                      message: "",
                    },
              ...
              <View style={styles.input}>
                <Text style={styles.inputLabel}>
                  Solicitudes expresas (Máximo 6)
                </Text>
                <Controller
                  control={control}
                  name="expresa"
                  rules={{
                    required: "Debe de escribir al menos una solicitud.",
                  }}
                  render={({ field: { onChange, value } }) => (
                    <>
                ...
                />
                {errors.expresa && (
                  <Text style={styles.errorText}>{errors.expresa.message}</Text>
                )}
              </View>
              ...
              <View style={styles.signatureContainer}>
                ...
                />
                {errors.firma && (
                  <Text style={styles.errorText}>{errors.firma.message}</Text>
                )}
                <View
                  style={{
                    flexDirection: "row",
              ...
              <View style={styles.formAction}>
                {processComplaint ? (
                  ...
                  <ButtonP onPress={handleSubmit(onSubmit)}>
